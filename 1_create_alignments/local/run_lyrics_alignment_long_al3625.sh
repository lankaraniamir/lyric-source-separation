...
# lyricspath=$2
# savepath=$3
wavpath=/home/lankaraniamir/new/kaldi-trunk/egs/new/ASA_ICASSP2021/a2l/audio/mashup_acapella.wav
...
if [[ $stage -le 4 ]]; then
    ...
    # steps/chain/get_phone_post.sh --remove-word-position-dependency false \
