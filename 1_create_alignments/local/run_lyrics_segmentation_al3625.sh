...
if [[ $stage -le 1 ]]; then
    ...
    # echo "VB RESEGMENTATION of ORIGINAL SEGMENTS"
    # steps/segmentation/convert_utt2spk_and_segments_to_rttm.py ${testset}/segments ${testset}/utt2spk ${testset}/rttm
    # local/VB_resegmenation.sh ${testset} ${testset}/rttm ${testset}_vad ${

    # cp -r ${testset} ${testset}_vad
