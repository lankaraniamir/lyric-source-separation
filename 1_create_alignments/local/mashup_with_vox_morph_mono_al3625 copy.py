...
COUNT=0
musdb_data = pd.read_csv("/home/lankaraniamir/kaldi-trunk/egs/lyric_separator/db/musdb18hq/musdb_hq_all_data.csv")
MUSDB_PATH = "/home/lankaraniamir/kaldi-trunk/egs/lyric_separator/db/other/musdb18hq_backup"
EXTRA_WAV_PATH = "/home/lankaraniamir/kaldi-trunk/egs/lyric_separator/db/my_stems"

MIX_PATH = "/home/lankaraniamir/kaldi-trunk/egs/lyric_separator/db/other/datasets/DALI-TestSet4ALT"

OUTPATH = Path.home() / 'kaldi-trunk/egs/lyric_separator/db/mashups_mono/'
...
def main():
    ...
    with ProcessPoolExecutor(20) as pool:
        ...
        if dset3:
            for index in range(len(dset3)):
                pendings.append(pool.submit(analyse_mixed_track, dset3, index))
