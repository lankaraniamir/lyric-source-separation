...
# lyricspath=$2
# savepath=$3
wavpath=/home/lankaraniamir/new/kaldi-trunk/egs/new/ASA_ICASSP2021/a2l/audio/mashup_mixture.wav
lyricspath=/home/lankaraniamir/new/kaldi-trunk/egs/new/ASA_ICASSP2021/a2l/audio/mashup.raw.txt
savepath=eutput_folder
...
wavpath_vocals=/home/lankaraniamir/new/kaldi-trunk/egs/new/ASA_ICASSP2021/a2l/audio/mashup_acapella.wav
#oovpath=/home/lankaraniamir/new/kaldi-trunk/egs/lyr_sep/data/oov/oov_words.txt
...
if [[ $stage -le 2 ]]; then
    ...
    ./steps/dict/apply_g2p_phonetisaurus.sh --nbest 2 $oovpath model/g2p data/local/${rec_id}
