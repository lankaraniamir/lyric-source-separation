...
src_mdl=model/ctdnnsa_ivec/final.mdl # Input chain model
...
src_ivec_extractor_dir=model/ivector/extractor  # Source ivector extractor dir used to extract ivector for
...
src_lang=data/lang_chain_4G # Source lang directory used to train source model.
...
src_dict=conf/dict  # dictionary for source dataset containing lexicon.txt,
                                            # nonsilence_phones.txt,...
                                            # lexicon.txt used to generate lexicon.txt for
                                            # src-to-tgt transfer.

# src_tree_dir=../../wsj/s5/exp/chain/tree_a_sp # chain tree-dir for src data;
src_tree_dir=model/tree # chain tree-dir for src data;
